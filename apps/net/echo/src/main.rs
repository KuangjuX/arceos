...
fn main() {
    ...
    loop {
        let mut pkt_data: [u8; 42] = [
            0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x90, 0xE2, 0xBA, 0x8C, 0x66, 0x88, 0x08, 0x06,
            0x00, 0x01, 0x08, 0x00, 0x06, 0x04, 0x00, 0x01, 0x90, 0xE2, 0xBA, 0x8C, 0x66, 0x88,
            0x0A, 0x02, 0x02, 0x02, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x0A, 0x02, 0x02, 0x1,
        ];
        send(&pkt_data);
        loop {
            match recv() {
